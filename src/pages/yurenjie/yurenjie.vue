          ...
          .then(res=>{
            wx.ready(function () {
              ...
              wx.onMenuShareTimeline({
                title: '愚人节专题123算术题', // 分享标题
                link: `http://${window.location.host}/ceshi/index.html#/yurenjie`, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
                imgUrl: '', // 分享图标
              });
            ...
            vm.location='http://seif.fsherun.cn/ceshi/h5game/yurenjie/index.html';
          })
      })
    },
    mounted(){
