  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/zhenai/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/zhenai/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 340, 803, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ctx.font = "50px 微软雅黑";
              ctx.fillStyle = '#ff7241';
              ctx.textAlign = "center";
              ctx.fillText(_this.nickname, 400, 60);
              resolve()
            })
          })
          .then(() => {
