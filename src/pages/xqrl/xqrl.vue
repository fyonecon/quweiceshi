  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/xqrl/cover.png" alt="" class="cover-img">
        ...
        <div class="radio-box" v-if="options.showRadio">
          <label for="man">
            <input type="radio" maxlength="4" id="man" name="sex" v-model="sex" value="male"> 我是男生
          </label>
          <label for="woman">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/xqrl/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 469, 697, 100, 100);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(_this.nickname, 305, 95);
              resolve()
            })
          })
          .then(() => {
