  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/jftzs/cover.jpg" alt="" class="cover-img">
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = `http://quweifiles.mukzz.pw/web-project/jftzs/0.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 102, 725, 100, 100);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText('', 0, 0);
              setTimeout(()=>{
                ctx.fillText(_this.nickname, 600, 840);
                resolve()
              },3000)
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "center";
              let date = new Date();
              ctx.fillText(`${date.getFullYear()}年${date.getMonth()+1}月${date.getDate()}日`, 600, 886);
              resolve()
            })
          })
          .then(() => {
