  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/lybtz/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/lybtz/0/';
  let womanLink = 'http://quweifiles.mukzz.pw/web-project/lybtz/1/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = this.sex === 'male'?`${manLink}${Math.round(Math.random() * 5)}.jpg`:`${womanLink}${Math.round(Math.random() * 13)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 560, 588, 100, 100);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "left";
              ctx.fillText(`${_this.nickname}的另一半特征`, 25, 650);
              resolve()
            })
          })
          .then(() => {
