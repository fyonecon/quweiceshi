<template>
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1">
        <img src="http://quweifiles.mukzz.pw/web-project/fortune/fortune.png" alt="" class="cover-img">
      ...
      <!--<div class="p2" v-show="step!==1">-->
      <!--<img ref="result" :src="result" alt="" class="result">-->
      <!--</div>-->
    </div>
    <list></list>
    <!-- 更多测试按钮-->
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/fortune/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 540, 770, 100, 100);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(_this.nickname, 400, 240);
              resolve()
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillStyle = '#000000';
              ctx.textAlign = "right";
              ctx.fillText('长按识别，看看你的新年运势 →', 520, 860);
              resolve()
            })
          })
          .then(() => {
