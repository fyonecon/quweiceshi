  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/hnzyfqxdmx/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/hnzyfqxdmx/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = `${manLink}${this.sex==='male'?Math.round(Math.random()*30):Math.round(Math.random()*20+30)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 315, 918, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${this.nickname}`, 375, 120);
              resolve()
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillStyle = '#000000';
              ctx.textAlign = "center";
              ctx.fillText(`长按识别，查看你的`, 375, 1092);
              resolve()
            })
          })
          .then(() => {
