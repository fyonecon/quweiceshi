  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/yqmqddcb/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/yqmqddcb/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 395, 739, 110, 110);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${this.nickname}`, 450, 140);
              resolve()
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillStyle = '#000000';
              ctx.textAlign = "center";
              ctx.fillText(`长按识别，查看你的`, 450, 888);
              resolve()
            })
          })
          .then(() => {
