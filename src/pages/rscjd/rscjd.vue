  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/rscjd/pic.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/rscjd/1/';
  let womanLink = 'http://quweifiles.mukzz.pw/web-project/rscjd/2/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = this.sex === 'male' ? `${manLink}${Math.round(Math.random() * 19)}.jpg` : `${womanLink}${Math.round(Math.random() * 19)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 610, 1026, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "left";
              ctx.fillText(_this.nickname, 173, 202);
              resolve()
            })
          })
          .then(() => {
