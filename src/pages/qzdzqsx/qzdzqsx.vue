  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/qzdzqsx/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/qzdzqsx/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 285, 788, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${this.nickname}`, 350, 164);
              resolve()
            })
          })
          .then(() => {
