      ...
      next(vm => {
        getHost(1)
          .then(res => {
            ...
            vm.location = 'http://seif.fsherun.cn/ceshi/h5game/hextris/index.html';
            wx.showMenuItems({
            ...
            wx.onMenuShareTimeline({
              title: '六角形消消乐', // 分享标题
              link: `http://${window.location.host}/ceshi/index.html#/hextris`, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
              imgUrl: '', // 分享图标
            });
