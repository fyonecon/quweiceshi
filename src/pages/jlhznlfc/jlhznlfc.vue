  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/jlhznlfc/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/jlhznlfc/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 290, 800, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${_this.nickname}`, 350, 130);
              resolve()
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillStyle = '#0000000';
              ctx.textAlign = "center";
              ctx.fillText(`长按识别查看你的发财地点`, 350, 950);
              resolve()
            })
          })
          .then(() => {
