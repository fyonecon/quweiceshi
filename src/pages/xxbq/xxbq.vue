  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/xxbq/cover.png" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/xxbq/1/';
  let womanLink = 'http://quweifiles.mukzz.pw/web-project/xxbq/0/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = this.sex==='male'?`${manLink}${Math.round(Math.random() * 9)}.jpg`:`${womanLink}${Math.round(Math.random() * 9)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 58, 666, 100, 100);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${_this.nickname}的形象标签`, 375, 115);
              resolve()
            })
          })
          .then(() => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillStyle = '#888888';
              ctx.textAlign = "left";
              ctx.fillText('查看属于我的形象标签', 175, 740);
              resolve()
            })
          })
          .then(() => {
