  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/ccndsyys/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/ccndsyys/';
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 323, 828, 100, 100);
                resolve()
              }
            })
          })
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "center";
              ctx.fillText(`长按识别查看你的五月运势`, 375, 965);
              resolve()
            })
          })
          .then(() => {
