  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/lanlfxt/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/lanlfxt/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = `${manLink}${Math.round(Math.random() * 19)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 507, 589, 120, 120);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "right";
              ctx.fillText(`${this.nickname}`, 190, 205);
              resolve()
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.textAlign = "right";
              ctx.fillText(`长按识别查看你的恋爱能力`, 660, 730);
              resolve()
            })
          })
          .then(() => {
