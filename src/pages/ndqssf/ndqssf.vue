  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/ndqssf/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/ndqssf/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = `${manLink}${Math.round(Math.random() * 39)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 277, 1030, 127, 127);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${this.nickname}`, 496, 226);
              resolve()
            })
          })
          .then(() => {
