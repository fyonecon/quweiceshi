  ...
  <div class="web-index">
    ...
    <div class="container">
      <div class="p1" v-show="step===1">
        <img src="http://quweifiles.mukzz.pw/web-project/gngjc/cover.jpg" alt="" class="cover-img">
...
<script>
  ...
  let manLink = 'http://quweifiles.mukzz.pw/web-project/gngjc/';
...
//            vm.count = res.statistics;
    ...
    methods: {
      ...
      async toResult(){
        ...
        Toast('加载中..');;
        let _this = this;
        let bg = `${manLink}${Math.round(Math.random() * 29)}.jpg`;
        ...
        new Promise((resolve, reject) => {
          ...
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              img.src = qrcode;
              img.onload = () => {
                ctx.drawImage(img, 293, 956, 125, 125);
                resolve()
              }
            })
          })
          .then(() => {
            return new Promise((resolve, reject) => {
              ...
              ctx.fillText(`${this.nickname}     睁大眼睛看`, 365, 428);
              resolve()
            })
          })
//          .then(() => {
...
//                ctx.save();
//                // 圆心 x,y,半径，起始角度，结束角度
//                ctx.arc(154, 366, 60, 0, 2 * Math.PI);
//                // 从画布上裁剪出这个圆形
//                ctx.clip();
//                ctx.drawImage(img, 94, 306, 120, 120);
//                ctx.restore();
//                resolve()
//              }
//            })
